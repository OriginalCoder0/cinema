...
public class MoviesUpdateServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(in.available() > 0){
            ...
            //上传文件到七牛OSS
            path = QiniuOssUtils.upload(in, fname);
        }
        //获取需求修改的影片id
        ...
        //执行修改
        boolean b = service.updateMovies(m);
        if(b){
            //修改成功
            ...
            req.getRequestDispatcher("../editMovies.jsp").forward(req,resp);
        }
